...
<div class="manager-content">
	...
	<form action="/manager/pages/update/id/{$page->page_id}" method="post" class="form">
		<div class="form-item">
			<label>Заголовок (в красной закладке):</label>
			<input id="title" onkeyup="insertLink()" type="text" value="{$page->title|stripslashes}" name="title" />
		</div>
		<div class="form-item">
            <label>Подробный заголовок:</label>
		...
		<div class="form-item">
			<label>Текст</label>
			<textarea id="tiny_mce" name="body">{$page->body|stripslashes}</textarea>
		</div>
		<div>
