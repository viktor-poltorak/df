...
// Query-Zeichenkette entschl黶seln
if (isset($_GET["get"])) {
...
// Query-Zeichenkette auf Vollst鋘digkeit 黚erpr黤en
if (!isset($QUERY["id"]) || !isset($QUERY["check_session_variable"])) {
	include("error.php");
	die;
}

// Verzeichnispfad 黚erpr黤en
...
// Eine Verzeichnisebene h鰄er anzeigen
