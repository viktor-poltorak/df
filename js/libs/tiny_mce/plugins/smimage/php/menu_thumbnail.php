<ul>
	...
	if ($SESSION["show_newfolder"] == 1) {
		echo "<li><a id=\"m2\" href=\"javascript:;\" title=\"\" onclick=\"NewFolder('".bin2hex(RC4("id=1&".$GET))."');\"><img src=\"img/icon_new_folder_24x24.png\" border=\"0\" /></a></li>";
		echo "<li><img class=\"separator\" src=\"img/icon_separator.png\" border=\"0\" /></li>";
	}
	...
	<li><a id="m5" href="javascript:;" title="" onclick="PageReload('<?php echo bin2hex(RC4("id=1&".$GET)); ?>'); if (window.event){ window.event.returnValue = false; }"><img src="img/icon_reload_24x24.png" border="0" /></a></li>
	<li><img class="separator" src="img/icon_separator.png" border="0" /></li>
