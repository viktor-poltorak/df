...
<div id="upload">
	<form name="form1" action="" method="post" enctype="multipart/form-data">
		...
		<div><input style="margin-bottom:8px;" type="file" name="input1" size="82" onchange="Upload_ShowFileName();"></div>
		...
		<div style="float:left;">
			...
			<div><input style="margin-bottom:8px; width:200px;" type="text" name="edit1" maxlength="50"><input style="width:40px; border-left:0px; font-weight:bold; background-color:#f6f9fb; margin-bottom:8px;" type="text" name="edit2" readonly></div>
		</div>
		...
		<div style="float:left; margin-left:25px;">
			...
			<div><input style="width:60px;" type="text" name="edit3" value="<?php if (isset($_POST["edit3"])) { echo $_POST["edit3"]; } ?>" maxlength="4"><b style="margin-left:5px;">px</b></div>
		</div>
		...
		<div style="margin-top:12px; margin-bottom:50px;">
			...
			jSMB.Paint('jSMB', tinyMCEPopup.getLang('smimage.upload_button_1', '?'), 'Upload_Save(\'<?php echo bin2hex(RC4("id=2&".$GET)); ?>\', document.form1.edit1.value + document.form1.edit2.value);');
			//-->
			</script>

			<!-- <div class="button" style="float:left;" onmouseout="this.style.backgroundImage='url(img/button_bg.png)';" onmouseover="this.style.backgroundImage='url(img/button_active_bg.png)';" onclick="Upload_Save('<?php echo bin2hex(RC4("id=2&".$GET)); ?>', document.form1.edit1.value + document.form1.edit2.value);"><b><script language="javascript" type="text/javascript">document.write(tinyMCEPopup.getLang('smimage.upload_button_1', '?'));</script></b></div> -->
		</div>
	</form>
</div>
...
<div id="wait" style="position:absolute; top:0px; left:0px; background-color:#616a74; filter:alpha(opacity=50); -moz-opacity:0.5; opacity:0.5;">
	<div id="wait_animation" style="position:absolute;"><img src="img/wait.gif" border="0" alt=""></div>
</div>

<script language="javascript" type="text/javascript">
<!--
// Upload-Animation ausblenden
